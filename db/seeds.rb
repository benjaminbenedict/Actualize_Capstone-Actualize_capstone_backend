...
user_plant8 = UserPlant.create!({ user_id: user3.id, plant_id: plant18.id, date_aquired: DateTime.new(2020, 5, 9) })
...
user_plant18 = UserPlant.create!({ user_id: user3.id, plant_id: plant19.id, date_aquired: DateTime.new(2021, 1, 5) })
user_plant19 = UserPlant.create!({ user_id: user3.id, plant_id: plant18.id, date_aquired: DateTime.new(2021, 2, 5) })
# user_plant11 = UserPlant.create!({user_id: user1.id,plant_id: plant1.id, date_aquired: ,})

Watering.create!({ user_plant_id: user_plant1.id, date: DateTime.new(2020, 12, 10) })
Watering.create!({ user_plant_id: user_plant1.id, date: DateTime.new(2021, 1, 10) })
Watering.create!({ user_plant_id: user_plant1.id, date: DateTime.new(2021, 2, 10) })
Watering.create!({ user_plant_id: user_plant2.id, date: DateTime.new(2021, 1, 5) })
Watering.create!({ user_plant_id: user_plant2.id, date: DateTime.new(2021, 2, 5) })
Watering.create!({ user_plant_id: user_plant2.id, date: DateTime.new(2021, 3, 5) })
Watering.create!({ user_plant_id: user_plant3.id, date: DateTime.new(2020, 11, 3) })
Watering.create!({ user_plant_id: user_plant3.id, date: DateTime.new(2021, 2, 15) })
Watering.create!({ user_plant_id: user_plant4.id, date: DateTime.new(2021, 01, 18) })
Watering.create!({ user_plant_id: user_plant4.id, date: DateTime.new(2021, 2, 05) })
Watering.create!({ user_plant_id: user_plant4.id, date: DateTime.new(2021, 2, 25) })
Watering.create!({ user_plant_id: user_plant4.id, date: DateTime.new(2021, 3, 5) })
Watering.create!({ user_plant_id: user_plant4.id, date: DateTime.new(2021, 3, 17) })
...
Watering.create!({ user_plant_id: user_plant5.id, date: DateTime.new(2021, 1, 10) })
...
Watering.create!({ user_plant_id: user_plant6.id, date: DateTime.new(2021, 3, 10) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2020, 10, 5) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2020, 10, 25) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2020, 11, 5) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2020, 11, 25) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2020, 12, 5) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2020, 12, 25) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 1, 5) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 1, 25) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 2, 5) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 2, 25) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 3, 5) })
Watering.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 3, 15) })
Watering.create!({ user_plant_id: user_plant8.id, date: DateTime.new(2021, 1, 15) })
Watering.create!({ user_plant_id: user_plant8.id, date: DateTime.new(2021, 1, 30) })
Watering.create!({ user_plant_id: user_plant8.id, date: DateTime.new(2021, 2, 15) })
Watering.create!({ user_plant_id: user_plant8.id, date: DateTime.new(2021, 3, 1) })
Watering.create!({ user_plant_id: user_plant8.id, date: DateTime.new(2021, 3, 16) })
Watering.create!({ user_plant_id: user_plant9.id, date: DateTime.new(2021, 3, 15) })
Watering.create!({ user_plant_id: user_plant10.id, date: DateTime.new(2021, 2, 3) })
Watering.create!({ user_plant_id: user_plant10.id, date: DateTime.new(2021, 2, 28) })
Watering.create!({ user_plant_id: user_plant10.id, date: DateTime.new(2021, 3, 1) })
Watering.create!({ user_plant_id: user_plant11.id, date: DateTime.new(2021, 2, 3) })
Watering.create!({ user_plant_id: user_plant11.id, date: DateTime.new(2021, 2, 18) })
Watering.create!({ user_plant_id: user_plant11.id, date: DateTime.new(2021, 3, 3) })
Watering.create!({ user_plant_id: user_plant11.id, date: DateTime.new(2021, 3, 18) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2020, 11, 3) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2020, 11, 29) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2020, 12, 15) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 1, 5) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 1, 25) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 2, 8) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 2, 28) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 3, 5) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 3, 15) })
Watering.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 3, 20) })
Watering.create!({ user_plant_id: user_plant13.id, date: DateTime.new(2020, 12, 30) })
Watering.create!({ user_plant_id: user_plant13.id, date: DateTime.new(2021, 2, 20) })
Watering.create!({ user_plant_id: user_plant13.id, date: DateTime.new(2021, 3, 18) })
Watering.create!({ user_plant_id: user_plant14.id, date: DateTime.new(2021, 1, 30) })
Watering.create!({ user_plant_id: user_plant14.id, date: DateTime.new(2021, 2, 25) })
Watering.create!({ user_plant_id: user_plant14.id, date: DateTime.new(2021, 3, 20) })
Watering.create!({ user_plant_id: user_plant15.id, date: DateTime.new(2020, 12, 25) })
Watering.create!({ user_plant_id: user_plant15.id, date: DateTime.new(2021, 1, 13) })
Watering.create!({ user_plant_id: user_plant15.id, date: DateTime.new(2021, 2, 13) })
Watering.create!({ user_plant_id: user_plant15.id, date: DateTime.new(2021, 3, 13) })
Watering.create!({ user_plant_id: user_plant16.id, date: DateTime.new(2021, 1, 13) })
Watering.create!({ user_plant_id: user_plant16.id, date: DateTime.new(2021, 1, 28) })
Watering.create!({ user_plant_id: user_plant16.id, date: DateTime.new(2021, 2, 15) })
Watering.create!({ user_plant_id: user_plant16.id, date: DateTime.new(2021, 2, 20) })
Watering.create!({ user_plant_id: user_plant17.id, date: DateTime.new(2021, 3, 10) })
Watering.create!({ user_plant_id: user_plant18.id, date: DateTime.new(2021, 1, 10) })
Watering.create!({ user_plant_id: user_plant18.id, date: DateTime.new(2021, 1, 25) })
Watering.create!({ user_plant_id: user_plant18.id, date: DateTime.new(2021, 2, 10) })
Watering.create!({ user_plant_id: user_plant18.id, date: DateTime.new(2021, 2, 15) })
Watering.create!({ user_plant_id: user_plant18.id, date: DateTime.new(2021, 3, 10) })
Watering.create!({ user_plant_id: user_plant18.id, date: DateTime.new(2021, 3, 22) })
Watering.create!({ user_plant_id: user_plant19.id, date: DateTime.new(2021, 2, 20) })
Watering.create!({ user_plant_id: user_plant19.id, date: DateTime.new(2021, 3, 5) })
Watering.create!({ user_plant_id: user_plant19.id, date: DateTime.new(2021, 3, 20) })
