...
Waterings.create!({ user_plant_id: user_plant1.id, date: DateTime.new(2021, 2, 3) })
Waterings.create!({ user_plant_id: user_plant1.id, date: DateTime.new(2021, 2, 10) })
Waterings.create!({ user_plant_id: user_plant1.id, date: DateTime.new(2021, 3, 1) })
Waterings.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 1, 3) })
Waterings.create!({ user_plant_id: user_plant7.id, date: DateTime.new(2021, 2, 15) })
Waterings.create!({ user_plant_id: user_plant11.id, date: DateTime.new(2021, 2, 3) })
Waterings.create!({ user_plant_id: user_plant10.id, date: DateTime.new(2021, 2, 3) })
Waterings.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 2, 3) })
Waterings.create!({ user_plant_id: user_plant3.id, date: DateTime.new(2021, 2, 3) })
Waterings.create!({ user_plant_id: user_plant3.id, date: DateTime.new(2021, 2, 15) })
Waterings.create!({ user_plant_id: user_plant5.id, date: DateTime.new(2021, 1, 5) })
Waterings.create!({ user_plant_id: user_plant5.id, date: DateTime.new(2021, 1, 7) })
Waterings.create!({ user_plant_id: user_plant6.id, date: DateTime.new(2021, 1, 9) })
Waterings.create!({ user_plant_id: user_plant6.id, date: DateTime.new(2021, 2, 20) })
Waterings.create!({ user_plant_id: user_plant13.id, date: DateTime.new(2020, 12, 30) })
Waterings.create!({ user_plant_id: user_plant14.id, date: DateTime.new(2021, 2, 25) })
Waterings.create!({ user_plant_id: user_plant15.id, date: DateTime.new(2021, 1, 13) })
Waterings.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 3, 1) })
Waterings.create!({ user_plant_id: user_plant2.id, date: DateTime.new(2020, 6, 5) })
Waterings.create!({ user_plant_id: user_plant12.id, date: DateTime.new(2021, 3, 5) })
Waterings.create!({ user_plant_id: user_plant2.id, date: DateTime.new(2020, 7, 5) })
...
Location_user_plant.create!({ user_plant_id: user_plant1.id, location_id: location1.id, date: DateTime.new(2020, 2, 3) })
Location_user_plant.create!({ user_plant_id: user_plant1.id, location_id: location2.id, date: DateTime.new(2021, 2, 3) })
Location_user_plant.create!({ user_plant_id: user_plant3.id, location_id: location2.id, date: DateTime.new(2021, 2, 3) })
Location_user_plant.create!({ user_plant_id: user_plant3.id, location_id: location3.id, date: DateTime.new(2021, 1, 30) })
Location_user_plant.create!({ user_plant_id: user_plant4.id, location_id: location4.id, date: DateTime.new(2021, 2, 17) })
Location_user_plant.create!({ user_plant_id: user_plant9.id, location_id: location4.id, date: DateTime.new(2021, 1, 18) })
Location_user_plant.create!({ user_plant_id: user_plant13.id, location_id: location5.id, date: DateTime.new(2021, 3, 3) })
